...
class BuyFrame extends JFrame {
    ...
    private void processPurchase() {
        ...
        // Validate inputs
        if (phoneName.isEmpty() || quantityText.isEmpty()) {
        ...
        try (Connection connection = DriverManager.getConnection(url);
            ...
            String selectQuery = "SELECT quantity FROM phones WHERE name = '" + phoneName + "'";
            ...
            if (resultSet.next()) {
                ...
                String updateQuery = "UPDATE phones SET quantity = quantity - " + quantity +
                        " WHERE name = '" + phoneName + "' AND quantity >= " + quantity;
