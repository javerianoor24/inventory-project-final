...
class DeletePhone extends JFrame {
    ...
    public DeletePhone() {
        ...
        JLabel phoneNameLabel = new JLabel("Phone Name:");
    ...
    private void processDelete() {
        ...
        try (Connection connection = DriverManager.getConnection(url);
            ...
            String deleteQuery = "DELETE FROM phones WHERE name = '" + phoneName + "'";
            ...
            if (rowsAffected > 0) {
                ...
                JOptionPane.showMessageDialog(this, "Phone not found or could not be deleted.", "Error", JOptionPane.ERROR_MESSAGE);
            }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            DeletePhone frame = new DeletePhone();
