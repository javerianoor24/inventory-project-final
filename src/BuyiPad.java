...
class BuyiPad extends JFrame {
    ...
    private void processPurchase() {
        ...
        try (Connection connection = DriverManager.getConnection(url);
            ...
            String selectQuery = "SELECT quantity, price FROM tablets WHERE name = '" + iPadName + "'";
            ...
            if (resultSet.next()) {
                ...
                String updateQuery = "UPDATE tablets SET quantity = quantity - " + quantity +
